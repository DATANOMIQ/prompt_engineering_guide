...
if not openai.api_key:
    ...
    print(
        "If you want to continue without setting the API key, example responses will be shown\n"
    )
...
from modules.instruction_prompting import (
    demonstrate_instruction_prompting,
    demonstrate_good_prompt_structure,
)
from modules.shot_prompting import (
    demonstrate_shot_based_prompting,
    demonstrate_few_shot_learning_tasks,
)
from modules.chain_of_thought import (
